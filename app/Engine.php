 ...
 * @method \app\org\View view() Gets current view
 *
 * Request-response
...
class Engine {
    ...
    public function init() {
        ...
        $this->loader->register('sess','\app\libs\common\ModeSession');
        $this->loader->register('view', '\app\org\View', array(), function($view) use ($self) {
        ...
        $this->set('sys.views.path', __DIR__ . '/tpl');
        $this->set('sys.views.cache', __DIR__ . '/tpl/cache');
