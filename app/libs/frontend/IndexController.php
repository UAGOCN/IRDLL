...
class IndexController extends BaseController{
    ...
    <p>2、如果不同意'.Api::fun()->getTitle().'对本协议相关条款所做的修改，用户有权并应当停止使用本网站。如果用户继续使用本网站，则视为用户接受本网站对本协议相关条款所做的修改。</p>
        ...
        Api::render('terms_privacy', array('domain' => Api::fun()->getDomain(),'title' => '服务条例 - '.Api::fun()->getTitle(),'section' => $section));
    }
    ...
    <p>电子邮箱：<span class="terms_span">'.Api::fun()->getEmail().'</span></p>
        ...
        Api::render('terms_privacy', array('domain' => Api::fun()->getDomain(),'title' => '隐私声明 - '.Api::fun()->getTitle(),'section' => $section));
    }
